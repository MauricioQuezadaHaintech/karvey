...
## D-38 — New change `living-docs`: instruction capture, living component sheets, README kept current
...
## D-39 — Production approval of wave1-hardening (3.12.0)

- **Who / when:** Mauricio Quezada Ibáñez, 2026-09-26 14:35 UTC. **Answer, verbatim:** «ok, merge a prod wave1-hardening 3.12.0» (recorded by the approval hook; audit prompt hash `4b9ca779…`).
- **What:** 3.12.0 released through PR #24, merge commit `e2acfab`; the approval is bound to the reviewed head `f6666d2` (D-35). CI on `main` (run 36249074745) green.
