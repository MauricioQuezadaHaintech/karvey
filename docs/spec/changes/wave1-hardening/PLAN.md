...
| E1.F5.T2 [Backend] | ✅ done | 45 | 9 | 0 | no human review yet; 39 table cases + 12 unit tests; local config helpers → F-10; 200-char pasted-line rule → F-11 |
...
| E1.F6.T4 [Test] | ✅ done | 30 | 5 | 0 | no human review yet; 23 session cases (5 nopy); runner: session event, setup commands, context assertions; test-hooks 58/58 incl. all tables |
