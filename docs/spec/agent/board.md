...
|---|---|---|---|---|---|
| B-01 | high | Wave 1 `wave1-hardening` → Karvey 3.12.0 | in_progress (impl, 61/73 tasks) | 2026-09-24 16:40 -03 | F-41/D-18 done, E1.F15.T1 done; E1.F13.T2: PR #24 green on every leg but lint (F-42..F-46 fixed), closes after F15.T3; remaining: E1.F15.T2 [owner], T3, qa, E1.F16.T1..T7 |
